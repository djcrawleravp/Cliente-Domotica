...
echo ""
apt-get update && apt-get upgrade -y > /dev/null 2>&1 || print_error "No se pudieron actualizar las dependencias"
...
echo "Añadiendo servidor a la red de Clentes"
echo ""
...
echo ""
wget https://raw.githubusercontent.com/djcrawleravp/Cliente-Domotica/main/descargar_imagenes.sh && chmod +x descargar_imagenes.sh && ./descargar_imagenes.sh > /dev/null 2>&1 || print_error "No se pudieron descargar las imágenes o instalar Portainer"
...
echo ""
wget https://raw.githubusercontent.com/djcrawleravp/Cliente-Domotica/main/agregar_coordinador.sh && chmod +x agregar_coordinador.sh && ./agregar_coordinador.sh > /dev/null 2>&1 || print_error "No se pudo ejecutar agregar_coordinador.sh"
